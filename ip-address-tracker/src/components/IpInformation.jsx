...
const IpInformation = ({ ipAddress, country, region, postalcode, timezone, isp }) => {
    return (
        <div className="rounded-xl bg-White sm:w-10/12 sm:flex sm:flex-col sm:gap-4 sm:items-center sm:py-8 lg:flex-row lg: justify-between  lg:py-10 lg:-mt-4 lg2:mt-0 xl:w-8/12">
            ...
            {country && region && (
                <div className="sm:flex sm:flex-col sm:items-center gap-2 lg:items-start  lg:border-l-2 border-DarkGray lg:px-4 lg2:px-8">
            ...
            {timezone && (
                <div className="sm:flex sm:flex-col sm:items-center gap-2 lg:items-start  lg:border-l-2 border-DarkGray lg:px-4 xl:py-4 lg2:px-8  xl:h-full">
                    <span className="text-DarkGray font-semibold sm:text-sm tracking-widest">TIMEZONE</span>
                    <h2 className="text-VeryDarkGray font-medium sm:text-xl xl:text-header">{timezone}</h2>
                </div>
            )}
